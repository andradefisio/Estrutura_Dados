...
#include "time.h"    // Para visualizar a classe Time. Qdo foi um arquivo que eu mesmo criei, o nome é colocado com aspas, como "time.h"
...
/* 
   Getters
 */
int Time::getHour() const {        // :: é o operador de resolução de escopo. Ele "parea" a classe com a implementação
  return hour;
}
